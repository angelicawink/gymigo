...
Workout.create(start_time: "9:00 AM", end_time: "10:00 PM", description: "Interested in a Zumba partner!", gym_id:1, user_id:3, amigo_id: 6, status: "booked")
Workout.create(start_time: "3:00 PM", end_time: "4:30 PM", description: "Need a spotter for leg day", gym_id:2, user_id:4, amigo_id: 5, status: "booked")
...
Workout.create(start_time: "3:00 PM", end_time: "4:30 PM", description: "love partner workouts!", gym_id:4, user_id:4, amigo_id: 5, status: "booked")
